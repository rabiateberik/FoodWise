        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SavedFoodKg = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    EstimatedCarbonSaved = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    SharedProductCount = table.Column<int>(type: "int", nullable: false),
                    WastedProductCount = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarbonReports_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenedShelfLifeDays = table.Column<int>(type: "int", nullable: true),
                    CarbonFactor = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    IsSensitiveFood = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockItems_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecipeRecommendations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecipeRecommendations_StockItems_StockItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShareListings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShareListings_AspNetUsers_DonorUserId",
                        column: x => x.DonorUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShareListings_DeliveryPoints_DeliveryPointId",
                        column: x => x.DeliveryPointId,
                        principalTable: "DeliveryPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShareListings_StockItems_StockItemId",
                        column: x => x.StockItemId,
                        principalTable: "StockItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredictedWasteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DaysRemaining = table.Column<int>(type: "int", nullable: false),
                    RecommendationType = table.Column<int>(type: "int", nullable: false),
                    RecommendationText = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WasteRiskPredictions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WasteRiskPredictions_StockItems_StockItemId",
                        column: x => x.StockItemId,
                        principalTable: "StockItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShareListingId = table.Column<int>(type: "int", nullable: false),
                    RequesterUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MatchScore = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShareRequests_AspNetUsers_RequesterUserId",
                        column: x => x.RequesterUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShareRequests_ShareListings_ShareListingId",
                        column: x => x.ShareListingId,
                        principalTable: "ShareListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deliveries_AspNetUsers_DonorUserId",
                        column: x => x.DonorUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_AspNetUsers_ReceiverUserId",
                        column: x => x.ReceiverUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_DeliveryPoints_DeliveryPointId",
                        column: x => x.DeliveryPointId,
                        principalTable: "DeliveryPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_ShareListings_ShareListingId",
                        column: x => x.ShareListingId,
                        principalTable: "ShareListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_ShareRequests_ShareRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarbonReports_UserId",
                table: "CarbonReports",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_DeliveryPointId",
                table: "Deliveries",
                column: "DeliveryPointId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_DonorUserId",
                table: "Deliveries",
                column: "DonorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_ReceiverUserId",
                table: "Deliveries",
                column: "ReceiverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_ShareListingId",
                table: "Deliveries",
                column: "ShareListingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_ShareRequestId",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeRecommendations_StockItemId",
                table: "RecipeRecommendations",
                column: "StockItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShareListings_DeliveryPointId",
                table: "ShareListings",
                column: "DeliveryPointId");

            migrationBuilder.CreateIndex(
                name: "IX_ShareListings_DonorUserId",
                table: "ShareListings",
                column: "DonorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ShareListings_StockItemId",
                table: "ShareListings",
                column: "StockItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShareRequests_ShareListingId",
                table: "ShareRequests",
                column: "ShareListingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WasteRiskPredictions_StockItemId",
